...
/**
 * Analyzes the image and dictionary of variables, send request to the model, and returns the response.
 * @param { Buffer } image - Image buffer for processing.
 * @param { object } dictOfVars - Dictionary of varianles.
 * @returns { Promise } - The reponse from the model after analysis.
 */
const analyzeImage = async (imageBuffer, dictOfVars) => {
    ...
    try {
        ...
        //clean the reponse
        const response = cleanResponse(responseText);
